    ...
    <footer id="contact" className="mt-20">
      <div className="bg-surface border-y border-border/50 py-16">
        <div className="container mx-auto px-4 md:px-8 flex flex-col md:flex-row justify-between items-center text-center md:text-left">
          ...
          <button className="mt-2 md:mt-0 flex items-center space-x-2 bg-primary text-black px-8 py-4 font-semibold hover:bg-white transition-colors duration-300">
      ...
      <div className="container mx-auto px-4 md:px-8 py-16 grid grid-cols-1 md:grid-cols-4 gap-12 text-center md:text-left">
        <div>
        ...
        <div className="flex flex-col space-y-3 text-sm text-gray-400 items-center md:items-start">
