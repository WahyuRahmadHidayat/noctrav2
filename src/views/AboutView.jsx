export default function AboutView() {
  return (
    <div className="min-h-screen bg-background text-white pt-32 pb-20 px-4 md:px-8 relative">
      <div className="absolute inset-0 bg-cover bg-center z-0 opacity-30" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1541625602330-2277a4c46182?q=80&w=2000&auto=format&fit=crop')" }} />
